...
<%--            </li>--%>
            ...
            <li name="customer_potential"><a href="/customer/potentialList"><i class="fa fa-circle-o"></i>
            潜在客户</a></li>
            <li name="customer_pool"><a href="/customer/poolList"><i class="fa fa-circle-o"></i> 客户池</a></li>
            <li name="customer_fail"><a href="/customer/failList"><i class="fa fa-circle-o"></i> 失败客户</a></li>
