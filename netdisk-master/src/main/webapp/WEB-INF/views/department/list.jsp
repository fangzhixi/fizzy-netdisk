            ...
            <div class="box">
                ...
                <div class="box-body table-responsive no-padding ">
                    <table class="table table-hover table-bordered" align="center">
                        ...
                        <c:forEach items="${pageInfo.list}" var="d" varStatus="vs">
                            <tr>
                                <td>${vs.count}</td>
                                <td>${d.name}</td>
                                <td>${d.sn}</td>
                                <td>
                                    <a class="btn btn-info btn-xs btn-input" href="/department/input?id=${d.id}">
                                        <span class="glyphicon glyphicon-pencil"></span> 编辑
                                    </a>
                                    <a href="javaScript:void();" data-url="/department/delete?id=${d.id}" class="btn btn-danger btn-xs btn-delete">
