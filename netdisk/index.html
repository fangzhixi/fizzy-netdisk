                      ...
                      <form>
                          <div class="input-prepend input-append">
                              <div class="btn-group">
                                  ...
                                  <input class="dropdown-toggle search-query text search-input" type="text"  placeholder="搜点什么吧..."><span class="search-replace"></span>
                                                  ...
                                                  <div class="media align-items-center mb-3">
                                                      ...
                                                      <div class="media-body ml-3">
                                                          <div class="media justify-content-between">
                                                              ...
                                                              <a href="index.html" class="mb-0 font-size-12"><i>切换账户</i></a>
                                                          </div>
        ...
        <div class="container-fluid">
            <div class="row">
                        ...
                        <div class="d-flex justify-content-between">                             
                            <div class="select-dropdown input-prepend input-append">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-toggle search-query">上传项目<i class="las la-angle-down ml-3"></i></div><span class="search-replace"></span>
                                    <span class="caret"><!--icon--></span>
                                    </label>
                                    <ul class="dropdown-menu">
                                        <li><div class="item"><i class="ri-folder-add-line pr-3"></i>新建文件夹</div></li>
                                        <li><div class="item"><i class="ri-file-upload-line pr-3"></i>上传文件</div></li>
                                        <li><div class="item"><i class="ri-folder-upload-line pr-3"></i>上传文件夹</div></li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-2">
                            ...
                            <a href="#" data-title="Demo.pdf" data-load-file="file" data-load-target="#resolte-contaniner" data-url="assets/vendor/doc-viewer/files/demo.pdf" data-toggle="modal" data-target="#exampleModal">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2">
                            ...
                            <a href="#" data-title="Demo.docx" data-load-file="file" data-load-target="#resolte-contaniner" data-url="assets/vendor/doc-viewer/files/demo.docx" data-toggle="modal" data-target="#exampleModal">
                                <div class="card card-block card-stretch card-height">
                                    <div class="card-body image-thumb">
                            <div class="mb-4 text-center p-3 rounded iq-thumb">
                                <div class="iq-image-overlay"></div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-2">
                            ...
                            <a href="#" data-title="Demo.xlsx" data-load-file="file" data-load-target="#resolte-contaniner"  data-url="assets/vendor/doc-viewer/files/demo.xlsx" data-toggle="modal" data-target="#exampleModal">
                                <div class="card card-block card-stretch card-height">
                                    <div class="card-body image-thumb">
                                <div class="mb-4 text-center p-3 rounded iq-thumb">
                                    <div class="iq-image-overlay"></div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-2">
                            ...
                            <a href="#" data-title="Demo.pptx" data-load-file="file" data-load-target="#resolte-contaniner" data-url="assets/vendor/doc-viewer/files/demo.pptx" data-toggle="modal" data-target="#exampleModal">
                                <div class="card card-block card-stretch card-height">
